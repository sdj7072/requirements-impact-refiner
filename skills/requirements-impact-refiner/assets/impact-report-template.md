...
```sh
python3 scripts/validate-impact-report.py REPORT.md
```
...
```sh
python3 scripts/validate-impact-report.py --previous PREVIOUS.md REPORT.md
```

To render the deterministic Delta without modifying either file:

```sh
python3 scripts/validate-impact-report.py --previous PREVIOUS.md --print-expected-delta REPORT.md
```
