...
```sh
python3 "$SKILL_DIR/scripts/validate-impact-report.py" --require-summary REPORT.md
```
...
```sh
python3 "$SKILL_DIR/scripts/validate-impact-report.py" --require-summary --previous PREVIOUS.md REPORT.md
```

To render the deterministic Delta without modifying either file:

```sh
python3 "$SKILL_DIR/scripts/validate-impact-report.py" --require-summary --previous PREVIOUS.md --print-expected-delta REPORT.md
```
